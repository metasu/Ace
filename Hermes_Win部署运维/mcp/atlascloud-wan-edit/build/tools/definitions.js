...
const toolDefinitions = [
    {
        name: 'edit_image',
        description: 'Edits an image using AtlasCloud Wan 2.7 API. Supports local file paths or URLs as image input. Supports multi-image reference composition. No content filtering. Returns the edited image as a URL or local file path.',
        inputSchema: {
            type: 'object',
            properties: {
                image: {
