...
const toolDefinitions = [
    {
        name: 'edit_image',
        description: 'Edits an image using AtlasCloud Seedream Sequential API. Supports local file paths or URLs as image input. No content filtering. Returns the edited image as a URL or local file path.',
        inputSchema: {
            type: 'object',
            properties: {
                image: {
                ...
                max_images: {
                    type: 'number',
                    description: 'Maximum number of images to generate (default: 1).',
                    minimum: 1,
                    maximum: 15,
                },
                seed: {
