...
const DEFAULT_IMAGE_MODEL = cliArgs.DEFAULT_IMAGE_MODEL || process.env.DEFAULT_IMAGE_MODEL || 'bytedance/seedream-v5.0-pro/text-to-image';
const DEFAULT_EDIT_IMAGE_MODEL = cliArgs.DEFAULT_EDIT_IMAGE_MODEL || process.env.DEFAULT_EDIT_IMAGE_MODEL || 'bytedance/seedream-v5.0-pro/text-to-image'; // Changed default model
