...
const toolDefinitions = [
    {
        name: 'generate_image',
        description: 'Generate an image via kuaipao OpenAI-compatible API (default model from env DEFAULT_IMAGE_MODEL, e.g. grok-image). Returns local_path and/or source_url. Prefer Markdown image links when URL is present.',
        inputSchema: {
            type: 'object',
            properties: {
